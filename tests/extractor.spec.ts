...
test.describe('PlaywrightReportParser', () => {
  test.describe('Basic Extraction', () => {
    test('should extract report statistics', async ({ runInlineTest }) => {
    ...
    test('should extract file structure', async ({ runInlineTest }) => {
      const result = await runInlineTest({
        'a.test.ts': `
          import { test, expect } from '@playwright/test';
          test('test 1', async () => {
  ...
  test.describe('Failing Tests', () => {
    test('should extract failing tests', async ({ runInlineTest }) => {
      const result = await runInlineTest({
        'a.test.ts': `
          import { test, expect } from '@playwright/test';
          test('passing test', async () => {
    ...
    test('should extract error messages', async ({ runInlineTest }) => {
      const result = await runInlineTest({
        'a.test.ts': `
          import { test, expect } from '@playwright/test';
          test('failing test', async () => {
    ...
    test('should extract timeout failures', async ({ runInlineTest }) => {
      const result = await runInlineTest(
        {
          'a.test.ts': `
          import { test, expect } from '@playwright/test';
    ...
    test('should extract trace file paths', async ({ runInlineTest }) => {
      const result = await runInlineTest({
        'a.test.ts': `
          import { test, expect } from '@playwright/test';
          test('failing test', async () => {
  ...
  test.describe('Edge Cases', () => {
    test('should handle tests with retries', async ({ runInlineTest }) => {
      const result = await runInlineTest(
        {
          'a.test.ts': `
          import { test, expect } from '@playwright/test';
    ...
    test('should handle skipped tests', async ({ runInlineTest }) => {
      const result = await runInlineTest({
        'a.test.ts': `
          import { test, expect } from '@playwright/test';
          test('passing test', async () => {
    ...
    test('should handle multiple errors in one test', async ({
      runInlineTest,
    }) => {
      const result = await runInlineTest({
        'a.test.ts': `
